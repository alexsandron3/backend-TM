...
CREATE TABLE `pagamento_passeio` (
    ...
    `previsaoPagamento` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `passeio` (
    ...
    `dataLancamento` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
